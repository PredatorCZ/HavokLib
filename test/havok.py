...
assert(xmToolset[17] == 'HK2013_1')
assert(xmToolset[18] == 'HK2013_2')
assert(xmToolset[19] == 'HK2013_3')
assert(xmToolset[20] == 'HK2014')
assert(xmToolset[21] == 'HK2015')
assert(xmToolset[22] == 'HK2016')
assert(xmToolset[23] == 'HK2017')
assert(xmToolset[24] == 'HK2018')
assert(xmToolset[25] == 'HK2019')
...
assert(xmToolset.HK2013_1 == 17)
assert(xmToolset.HK2013_2 == 18)
assert(xmToolset.HK2013_3 == 19)
assert(xmToolset.HK2014 == 20)
assert(xmToolset.HK2015 == 21)
assert(xmToolset.HK2016 == 22)
assert(xmToolset.HK2017 == 23)
assert(xmToolset.HK2018 == 24)
assert(xmToolset.HK2019 == 25)
