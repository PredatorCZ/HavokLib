...
REFLECTOR_WOENUM_WREMAP(hkaAnimationType, UNKNOWN_ANIMATION, INTERLEAVED_ANIMATION, DELTA_COMPRESSED_ANIMATION, WAVELET_COMPRESSED_ANIMATION, MIRRORED_ANIMATION, SPLINE_COMPRESSED_ANIMATION, QUANTIZED_COMPRESSED_ANIMATION, PREDICTIVE_COMPRESSED_ANIMATION, REFERENCE_POSE_ANIMATION);

struct AnimationType1
{
	REFLECTOR_ENUM_HASH(AnimationType, UNKNOWN_ANIMATION, INTERLEAVED_ANIMATION, DELTA_COMPRESSED_ANIMATION, WAVELET_COMPRESSED_ANIMATION, MIRRORED_ANIMATION, SPLINE_COMPRESSED_ANIMATION) //550, 660, 710
};
struct AnimationType2010
{
	REFLECTOR_ENUM_HASH(AnimationType, UNKNOWN_ANIMATION, INTERLEAVED_ANIMATION, DELTA_COMPRESSED_ANIMATION, WAVELET_COMPRESSED_ANIMATION, MIRRORED_ANIMATION, SPLINE_COMPRESSED_ANIMATION, QUANTIZED_COMPRESSED_ANIMATION)
};
struct AnimationType2011
{
	REFLECTOR_ENUM_HASH(AnimationType, UNKNOWN_ANIMATION, INTERLEAVED_ANIMATION, MIRRORED_ANIMATION, SPLINE_COMPRESSED_ANIMATION, QUANTIZED_COMPRESSED_ANIMATION, PREDICTIVE_COMPRESSED_ANIMATION)
};
...
>struct hkaSkeletalAnimation_t_shared : _parent<_ipointer, AniType>
{
	...
	ES_FORCEINLINE hkaAnnotationTrackPtr GetAnnotation(char *masterbuffer, int id) const
	{
...
>struct hkaAnimation2k_sharedData_t : _parent<_ipointer>
{
	...
	mutable hkArray<_ipointer<annot_type>, _ipointer> annotations;
};
