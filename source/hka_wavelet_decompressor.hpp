...
struct hkaWaveletDecompressor {
  void Assign(hkaWaveletCompressedAnimationInternalInterface *input);
...
inline void hkaWaveletDecompressor::GetFrame(size_t trackID, int32 frame,
